...
bucket_name="rtp2-shell-rtp-scripting1-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="valisharmas002@gmail.com"
...
aws s3 cp test1.txt s3://"$bucket_name"/test1.txt

# Create a Zip file to upload Lambda Function
zip -r s3-lambda-function.zip lambda_folder/
...
aws sns publish \
  ...
  --message "Hello, This is yourr Shell scripting project"
